    ...
    <div class="nav">
        ...
        <li>
          <Dropdown  placement="bottom-start">
            <a href="javascript:void(0)">
              <Icon type="md-pin" class="icon"></Icon> {{city}}
            </a>
      ...
      <ul class="detail">
        ...
        <li v-show="!isShow">
          <Dropdown>
            <p class="username-p">
              <Avatar class="person-icon" icon="md-person" size="small" /> <span class="username">{{ username }} </span>
            </p>
            <DropdownMenu slot="list">
                <div class="my-page">
                  <router-link to="/personalCenter"><Button type="error">我的信息</Button></router-link>
