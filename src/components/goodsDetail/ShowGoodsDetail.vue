    ...
    <div class="item-intro-show">
      <div class="item-intro-recommend">
        ...
        <div class="item-intro-recommend-column">
          ...
          <!-- test -->
          <div class="item-recommend-column" v-for="(item, index) in '11111'" :key="index">
            <div class="item-recommend-img">
            ...
            <div class="item-recommend-intro">
              ...
              <span class="item-recommend-price">￥111</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <Tabs>
            <TabPane label="商品介绍">
              ...
              <div class="item-intro-img" ref="itemIntroGoods">
                ...
                <img src="@/assets/img/goodsDetail/intro/2.jpg" alt v-for="(item,index) in '111'" :key="index" />
              </div>
            </TabPane>
            <TabPane label="规格参数">
              <div class="remarks-title">
              ...
              <div class="item-param-container">
                <span
                  ...
                  v-for="(item,index) in getGoodsDetail.param"
                  :key="index"
                >
                ...
                <span
                  class="item-param-box"
                  v-for="(item,index) in '111111111'"
                  :key="index"
                >
                  <span class="item-param-title">商品名称:</span>
                  <span class="item-param-content">iPhone 7手机壳</span>
                </span>
              </div>
            </TabPane>
            <TabPane label="售后保障">
                ...
                <div class="remarks-analyse-box">
                  ...
                  <div class="remarks-analyse-tags">
                    <Tag
                      ...
                      v-for="(item,index) in getGoodsDetail.remarks.remarksTags"
                      :key="index"
                    >{{item}}</Tag>
                  </div>
                </div>
