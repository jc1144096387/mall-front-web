    ...
    <div class="item-detail-show">
      <div class="item-detail-left">
        ...
        <div class="item-detail-img-row">
          <div class="item-detail-img-small" v-for="(item, index) in '1111'" :key="index" @mouseover="showBigImg(index)">
            <!-- <img :src="item" alt=""> -->
            <img src="@/assets/img/goodsDetail/item-detail-1.jpg" alt="">
          </div>
        </div>
      ...
      <div class="item-detail-right">
        <div class="item-detail-title">
          <p>
            <span class="item-detail-express">校园配送</span> 苹果8/7手机壳iPhone7 Plus保护壳全包防摔磨砂硬外壳</p>
        </div>
        ...
        <div class="item-detail-price-row">
          ...
          <div class="item-price-right">
            <div class="item-remarks-sum">
              <p>累计销售</p>
              <p>
                <span class="item-remarks-num">1111 </span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="item-select">
          ...
          <div class="item-select-container">
            <div class="" v-for="(item, index) in '11111111'" :key="index">
