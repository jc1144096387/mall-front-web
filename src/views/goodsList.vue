    ...
    <div class="container">
      ...
      <div class="goods-box">
        <div class="as-box">
          ...
          <!-- test -->
          <div class="item-as" v-for="(item, index) in '1111'" :key="index">
            <div class="item-as-img">
              <img src="@/assets/mock/item-show-8.jpg" alt="">
            </div>
            <div class="item-as-price">
              <span>
                <Icon type="social-yen text-danger"></Icon>
                <span class="seckill-price text-danger">29.9</span>
              </span>
            </div>
            <div class="item-as-intro">
        ...
        <div class="goods-list-box">
          ...
          <div class="goods-list">
            ...
            <!-- test -->
            <div class="goods-show-info" v-for="(item, index) in '11111111111111'" :key="index">
              <div class="goods-show-img">
                <router-link :to="{ path: '/goodsDetail', query: { goodsId: item.goodsId, merchantId: item.merchantId } }"><img src="@/assets/mock/item-show-8.jpg" alt=""></router-link>
              </div>
              <div class="goods-show-price">
                <span>
                  <Icon type="social-yen text-danger"></Icon>
